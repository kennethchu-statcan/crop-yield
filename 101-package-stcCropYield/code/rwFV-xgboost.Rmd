...
```{r}
DF.parcel.2013 <- readRDS( file.path("rwFV","010-predictions","xgboost_multiphase_1","2013","predictions-xgboost_multiphase_1-parcel.RData") )
...
```{r}
DF.parcel.2020 <- readRDS( file.path("rwFV","010-predictions","xgboost_multiphase_1","2020","predictions-xgboost_multiphase_1-parcel.RData") )
knitr::kable(head(DF.parcel.2020), align = "c")
```

```{r}
DF.parcel.2020.phase02 <- DF.parcel.2020[DF.parcel.2020[,'phase'] > 1,]
knitr::kable(DF.parcel.2020.phase02, align = "c")
```
